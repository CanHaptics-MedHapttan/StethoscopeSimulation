...
// Load the images
  ...
  waveformSamples[1].intensityMultiplier = 1.5f;
  waveformSamples[2].intensityMultiplier = 1.2f;
    ...
    if(haplyBoard != null) {
      if(haplyBoard.data_available()){
        ...
        if(renderWaveForm && currentSampleIndex != -1){         
          ...
          fEE.y = map(waveformValue, -0.5f, 1, -4, 4) * waveformSamples[currentSampleIndex].intensityMultiplier;
          fEE.x = 0.0f;
